...
plot(steps_by_interval$interval,steps_by_interval$steps, type="l",  col="blue", xlab="Interval", ylab="Number of Steps",main="Average Number of Steps per Day by Interval")
```
